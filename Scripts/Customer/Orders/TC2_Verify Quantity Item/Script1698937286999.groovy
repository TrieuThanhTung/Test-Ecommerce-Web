...
WebUI.setText(findTestObject('Page_Web Phone/Order/input_Quantity_productNumber'), '-5')

WebUI.click(findTestObject('Object Repository/Page_Web Phone/Order/button_Add to cart'))

WebUI.verifyElementNotPresent(findTestObject('Page_Web Phone/Order/button_OK'), 5)
...
WebUI.verifyElementNotPresent(findTestObject('Page_Web Phone/Order/div_Thank you for your purchase'), 5)
