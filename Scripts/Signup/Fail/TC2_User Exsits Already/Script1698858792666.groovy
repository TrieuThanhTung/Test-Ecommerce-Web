...
WebUI.setText(findTestObject('Page_Web Phone/Signup/input_Username_username'), 'tranviet')

WebUI.setText(findTestObject('Page_Web Phone/Signup/input_Password_password'), 'tranviet123')

WebUI.setText(findTestObject('Page_Web Phone/Signup/input_Comfirm Password_confirmpassword'), 'tranviet123')

WebUI.setText(findTestObject('Page_Web Phone/Signup/input_Email_email'), 'viet@katalon.com')
